...
void measurementVelocity::cluster_callback(const obstacle_detection::classificationData::ConstPtr& msg)
{
    //データをコピー
...
void measurementVelocity::matching_callback(const obstacle_detection::imageMatchingData::ConstPtr& msg)
{
    //データをコピー
